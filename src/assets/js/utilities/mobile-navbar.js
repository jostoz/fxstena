...
class MobileNavbar {
    ...
    createMobileNav(navbar) {
        ...
        // check previous mobile button and modal also remove if exist
        if(document.querySelector('.btn-mobile-navbar') !== null) {
            document.querySelector('.btn-mobile-navbar').remove()
        }
        if(document.querySelector('#navbarModal') !== null) {
            document.querySelector('#navbarModal').remove()
        }

        // append offcanvas element into navbar
        this.optionalNav.closest('.container').appendChild(btnOpen)
        this.optionalNav.closest('.container').appendChild(modalWrapper)
    }
